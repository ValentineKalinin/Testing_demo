...
public class WebSampleTest implements IAbstractTest {
    ...
    public void testModelSpecs() {
        ...
        HomePageSample homePageSample = new HomePageSample(getDriver());
        homePageSample.open();
        Assert.assertTrue(homePageSample.isPageOpened(), "Home page is not opened");

        //Closing advertising if it's displayed
        homePageSample.getWeValuePrivacyAd().closeAdIfPresent();

        // Select phone brand
        homePageSample = new HomePageSample(getDriver());
        BrandModelsPage productsPage = homePageSample.selectBrand("Samsung");
        // Select phone model
        ModelInfoPageSample productInfoPage = productsPage.selectModel("Galaxy A52 5G");
    ...
    public void testCompareModels() {
        ...
        FooterMenu footerMenu = homePageSample.getFooterMenu();
    ...
    public void testNewsSearch() {
        ...
        NewsPageSample newsPage = homePageSample.getFooterMenu().openNewsPage();
